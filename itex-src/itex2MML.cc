/*
    itex2MML  1.3.3
    website : https://golem.ph.utexas.edu/~distler/blog/itex2MML.html
    repository : https://golem.ph.utexas.edu/~distler/code/itexToMML/
    renamed to "itex2MML"
...
char itex2MML_id[64]; // is set by cmd-line argument "--mathml-id" via wims
...
int main (int argc, char ** argv)
{
			...
			if (args == "--version" || args == "-v")
				{
					fputs("itex2MML version " ITEX2MML_VERSION "\n"
					      "See https://golem.ph.utexas.edu/~distler/blog/itex2MML.html for more information.\n", stdout);
					bStop = true;
					break;
				}
	...
	snprintf(itex2MML_id,sizeof(itex2MML_id),"itex2MML%ld",long(tv.tv_usec));
	...
	else // standard syntax echo  "\frac{1}{2}" | itex2MML --inline > test.xml
